...
%[V,F] = readOBJ('C:/Users/ullala/GitHub/Mesh_deformation_for_remote_local_AR_workspaces/programs_mesh_deformatinos/example_meshes/circular_mesh_triangulate.obj');
[V,F] = readOBJ('C:/gptoolbox/spot/spot_triangulated.obj');
E=sqrt((V(:,1) .^ 2 + (V(:,2) .^ 2)));
index0=find(E==0.4);
index1=find(E==1);
tsurdhandles = [index0;index1];
v0=[0.0,0.5,0];
v1=[0.1,0,0];
